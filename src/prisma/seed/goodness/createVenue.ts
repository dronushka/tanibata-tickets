...
export default async function createVenue () {
    let mailMessage = '\
        <p dir="auto">Благодарим Вас за поддержку фестиваля ( аже не имея возможности посетить его лично) — приобретение билета Добро! Вам будет отправлен набор эксклюзивных сувениров фестиваля. Отправка будет осуществлена по почте на адрес, указанный при оформлении билета.</p>\
    '

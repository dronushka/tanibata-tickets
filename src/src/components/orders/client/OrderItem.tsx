...
import { Box, Button, FileButton, Group, Input, List, Paper, Stack, Text } from "@mantine/core"
...
export default function OrderItem({ order }: { order: HydratedOrder }) {
    ...
    const {mutate: uploadCheque} = trpc.uploadCheque.useMutation()
    ...
    return (
        ...
        >
            <Stack>
                    ...
                    <Group>
                        ...
                        <Box>
                            ...
                            {order.id !== loading && (
                                <FileButton
                                    onChange={ (value) => {
                                        uploadCheque({ orderId: order.id })
                                    }
                                        // sendCheque(order.id, value)
                ...
                <Input.Error>
                    {orderError?.orderId === order.id ? orderError.error : ""}
                </Input.Error>
            </Stack>
        </Paper>
    )

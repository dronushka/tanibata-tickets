    ...
    return (
        <Paper shadow="sm" radius="md" p="md">
            <Stack>
                ...
                <Textarea
                    label='К заказу также можно оставить комментарий (если вы покупали "Добро без посещения фестиваля", впишите сюда адрес, индекс, контактный телефон и полное ФИО для отправки сувениров):'
                    maxLength={1000}
                    value={comment}

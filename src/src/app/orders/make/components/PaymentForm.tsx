        ...
        <Paper shadow="sm" radius="md" p="md">
            <Stack>
                ...
                <Box>
                    ...
                    <Text>Покупая билет на концерт с опцией «Добро» вы получаете доступ <strong>только на Концерт фестиваля</strong>,
                         т.к. билеты на Косплей-шоу на данный момент полностью распроданы и <strong>свободных мест на Косплей-шоу в зале нет</strong>.</Text>
                </Box>
                <Textarea

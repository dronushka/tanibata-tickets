 ...
 */}
            ...
            <Text mb="md">
                ...
                <Link href="https://vk.com/tanibata">Танибата, Нян-фест и Алоха — фестивали в Ростове</Link>
            </Text>
            ...
            <Text>
                — билет на косплей-шоу и концерт «Добро» с пакетом сувениров от фестиваля, ранним входом в зал и экскурсией — 2500
                рублей.
            </Text>
            <Text fw="lighter" mt="xs" mb="md">
                Ближе к мероприятию стоимость может увеличиться.
            </Text>
            <Text fw="bold" mb="md">
                Что происходит после окончания косплей-шоу?
            </Text>
            <Text mb="md">Откроем тайну — фестиваль на этом не заканчивается!</Text>
            <Text mb="md">
                Мы ждём тебя на концерте и обещаем много интересного от эстрадных звёзд «Танибаты», «Нян-феста» и, конечно же,
                «Алохи»!
            </Text>
            <Text mb="md">
                Основная часть вокальных и изрядная доля танцевальных выступлений, которые не поместились в программу косплей-шоу,
                порадуют тебя на концерте. Это около 30 песен и танцев в ламповой и уютной атмосфере, в мягких креслах, в которых
                так приятно расслабиться после целого дня активностей и драйва «Нян-феста».
            </Text>
            <Text mb="md">
            ...
            <Text fw="bold" mb="md">
                Билет на Концерт - 300 рублей
            </Text>

            {/* <Group sx={{ justifyContent: "center" }} mb="sm">
            {venues.map(venue => <Stack key={venue.id} sx={{minWidth: 200, flexBasis: 0, flexGrow: 1, flexShrink: 0}}>
                <Text fw="bold" sx={{textWrap: "nowrap"}}>{venue.name}</Text>
            ...
            <Grid>
                {venues.map((venue) => (
                    <Grid.Col xs={12} sm={6} lg={4}>
                        ...
                        <Link href={"/orders/make/" + venue.id} passHref legacyBehavior>
                            <Button component="a" fullWidth>Купить билеты</Button>
                        </Link>
                    </Grid.Col>
                ))}
            </Grid>

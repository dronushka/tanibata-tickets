...
export default function Help() {
    return (
        <FullAreaMessage>
            ...
            <Text mb="md">Перевод на имя: Дмитрий Вадимович З.</Text>
            ...
            <Text mb="md">
                Возврат билетов прекращается за один час до начала фестиваля. Вернуть билет на 1-ый день фестиваля во 2-й день невозможно.
            </Text>
            <Text mb="md">
